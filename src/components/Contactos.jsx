  ...
  return (
    <section className="pad">
      ...
      <div>
        <div className="card">
          <div className="pieContacto">
            <a target="_blank" rel="noopener noreferrer"  href={linkMuebles}>
      ...
      <div>
        <div className="card">
          <div className="pieContacto">
            <a target="_blank" rel="noopener noreferrer"  href={linkTecnologia}>
      ...
      <div>
        <div className="card">
          <div className="pieContacto">
            <a target="_blank" rel="noopener noreferrer"  href={linkColchones}>
            ...
            <div className="container-fluid">
                <div className="row">
                    <div className="ps-2 col-12">
                        <h4>Sucursales</h4>
                        <p>Casa central, Polledo 45, Rafael Castillo / teléfono: 1175353509 / horarios: lun a sab 9 a 13 hs y de 16:30 a 20 hs </p>
                        <p>Muebleria, Polledo 27, Rafael Castillo / teléfono: 1160692736 / horarios: lun a sab 9 a 13 hs y de 16:30 a 20 hs</p>
                        <p>Colchoneria, Cristiania 1683, Isidro Casanova / teléfono: 1120722672 / horarios: lun a sab 9 a 13 hs y de 16:30 a 20 hs</p>
                        <p>San Justo, Arieta 2639, San Justo / teléfono: 1154785445 / horarios: lun a sab 9 a 13 hs y de 15 a 18 hs</p>
                    </div>
                </div>
                <div>
          <iframe src="https://www.google.com/maps/d/embed?mid=17DaENuBW9v1ZbigMtk7FFA7zWBxI7II_&ehbc=2E312F" width="" height="500" allowfullscreen frameborder="0" class="col-12 pb-3"></iframe>
          </div>
            </div>
